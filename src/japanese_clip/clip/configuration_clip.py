...
if __name__ == '__main__':
    import os, sys
    from transformers import ViTConfig, BertConfig, T5Tokenizer
    current = os.path.dirname(os.path.realpath(__file__))
    parent = os.path.dirname(current)
    tokenizer = T5Tokenizer.from_pretrained(os.path.join(parent, 'storage/tokenizer'))
    tokenizer.save_pretrained(os.path.join(parent, 'storage/tokenizer'))
    print(tokenizer.convert_ids_to_tokens(tokenizer('おはよう．今日はなにしてるの？').input_ids))
    ...
    # )
    # https://github.com/google-research/vision_transformer/blob/main/vit_jax/models_lit.py
    # https://github.com/google/flaxformer/blob/main/flaxformer/architectures/bert/configs.py#L56
    ...
    vision_config = ViTConfig.from_pretrained(os.path.join(parent, "storage/vit_base_patch16_224"))
    vision_config = vision_config.to_dict()
    vision_config.pop('label2id')
    vision_config.pop('id2label')
    config = CLIPConfig(
    ...
    config.save_pretrained(os.path.join(parent, 'clip'))
